...
4. **Save** via the l0-memory MCP `memory_save` tool: `scope` from step 1, a stable `key`, the synthesized `value`, useful `tags`, and `origin_agent: "claude-code"`. Confirm the key you used.
